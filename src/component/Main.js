      ...
      .then((result) => {
        ...
        if (reviewData && reviewData.length > 0) {
          const filteredImages = reviewData
            ...
            .map(review => `http://13.209.93.111:8070/images/${review.reviewimg}`); // 이미지 URL 설정
    ...
    <>
      ...
      <div className="flex min-h-[100dvh] flex-col w-full">
        <section className="w-full bg-gradient-to-r from-[white] to-[white] py-20 md:py-15" style={{
          backgroundImage: 'url(http://13.209.93.111:8070/images/oceans.jpg)',
        ...
        <div className="flex space-x-4 items-center">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm w-[300px] hover:scale-105" data-v0-t="card">
              <img
                src="http://13.209.93.111:8070/images/ulleungdo.jpg"
                alt="Forest"
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm w-[300px] hover:scale-105" data-v0-t="card">
              <img
                // src="http://13.209.93.111:8070/images/jeju2.jpg"
                src="http://13.209.93.111:8070/images/jeju2.jpg"
                alt="Beach"
                className="w-full h-[200px] object-cover rounded-t-md"
                width="300"
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm w-[300px] hover:scale-105" data-v0-t="card">
              <img
                // src="http://13.209.93.111:8070/images/gujedo.jpg"
                src="http://13.209.93.111:8070/images/jeju2.jpg"
                alt="Field"
                className="w-full h-[200px] object-cover rounded-t-md"
                width="300"
