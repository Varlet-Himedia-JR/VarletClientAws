...
function Heading() {
    ...
    const [profileImg, setProfileImg] = useState('http://13.209.93.111:8070/images/user.png');
        ...
        axios.get(`/api/member/getMyProfileImg/${userid}`, {
            ...
            .then((result) => {
                ...
                if (profileImgUrl) {
                    ...
                    setProfileImg('http://13.209.93.111:8070/images/user.png'); // 기본 이미지로 설정
                }
            })
            .catch((err) => {
                console.error(err);
    ...
    return (
        <div className='header'>
            <div className='category_menu'>
                <div className='logo'>
                    <img src="http://13.209.93.111:8070/images/varlet.png" onClick={() => navigate('/')} alt="Logo" />
                </div>
